...
const Connections = () => {
  ...
  // Get the current tab data safely
            ...
            <button 
              ...
              className={`cursor-pointer flex items-center px-3 py-1 text-sm rounded-md transition-colors ${
                currentTab === tab.label 
                  ? 'bg-white font-medium text-black underline' 
          ...
          {currentTabData.map((user) => (
            <div key={user._id} className='w-full max-w-88 flex gap-5 p-6 bg-white shadow rounded-md'>
              ...
              <div className='flex-1'>
                ...
                <p className='text-sm text-slate-600'>{user.bio?.slice(0, 30)}...</p> {/* Added optional chaining */}
