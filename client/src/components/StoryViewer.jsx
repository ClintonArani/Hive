...
const StoryViewer = ({ viewStory, setViewStory }) => {
  ...
  return (
    <div
      className="fixed inset-0 h-screen bg-black bg-opacity-90 z-100 flex items-center justify-center"
      style={{
        backgroundColor:
    ...
    >
      ...
      {/* user info - top left */}
      <div className="absolute top-4 left-4 items-center space-x-3 px-4 sm:p-4 sm:px-8 backdrop-blur-2xl rounded bg-black/50">
        <img
